...
func (x *RequestSession) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_session_proto_rawDesc = []byte{
	...
	0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x26, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x65, 0x72, 0x49, 0x44, 0x32, 0x3d, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	0x32, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x1a, 0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49,
...
var file_session_proto_goTypes = []interface{}{
	(*RequestSession)(nil), // 0: grpc.RequestSession
	(*SessionInfo)(nil),    // 1: grpc.SessionInfo
}
var file_session_proto_depIdxs = []int32{
	0, // 0: grpc.Session.Session:input_type -> grpc.RequestSession
	1, // 1: grpc.Session.Session:output_type -> grpc.SessionInfo
...
type SessionClient interface {
	Session(ctx context.Context, in *RequestSession, opts ...grpc.CallOption) (*SessionInfo, error)
}
...
func (c *sessionClient) Session(ctx context.Context, in *RequestSession, opts ...grpc.CallOption) (*SessionInfo, error) {
	out := new(SessionInfo)
	err := c.cc.Invoke(ctx, "/grpc.Session/Session", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SessionServer interface {
	Session(context.Context, *RequestSession) (*SessionInfo, error)
}
...
func (*UnimplementedSessionServer) Session(context.Context, *RequestSession) (*SessionInfo, error) {
...
func _Session_Session_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestSession)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServer).Session(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Session/Session",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServer).Session(ctx, req.(*RequestSession))
	}
	return interceptor(ctx, in, info, handler)
}

var _Session_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.Session",
	HandlerType: (*SessionServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Session",
			Handler:    _Session_Session_Handler,
		},
	},
