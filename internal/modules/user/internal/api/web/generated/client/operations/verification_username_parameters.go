...
/* VerificationUsernameParams contains all the parameters to send to the API endpoint
   for the verification username operation.
...
// WithDefaults hydrates default values in the verification username params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *VerificationUsernameParams) WithDefaults() *VerificationUsernameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the verification username params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *VerificationUsernameParams) SetDefaults() {
