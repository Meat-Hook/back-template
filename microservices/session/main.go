...
import (
	...
	"github.com/Meat-Hook/back-template/microservices/session/internal/api/web"
	"github.com/Meat-Hook/back-template/microservices/session/internal/api/web/generated/restapi"
	"github.com/Meat-Hook/back-template/microservices/session/internal/app"
	"github.com/Meat-Hook/back-template/microservices/session/internal/auth"
	"github.com/Meat-Hook/back-template/microservices/session/internal/repo"
	wrapper "github.com/Meat-Hook/back-template/microservices/session/internal/users"
	users "github.com/Meat-Hook/back-template/microservices/user/client"
...
func start(c *cli.Context) error {
	...
	grpcConn, err := librpc.Client(c.Context, c.String(userSrv.Name))
	if err != nil {
	...
	authModule := auth.New(c.String(authKey.Name))

	module := app.New(r, wrapper.New(usersSvcClient), authModule, idGen{})
